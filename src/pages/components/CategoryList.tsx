...
const CategoryList = (): JSX.Element => {
  return (
    <>
      <div className="mt-10 ml-10  w-[16rem] text-gray-400 bg-white/10 h-[70vh] rounded-md">
        <div className="border-b-2 border-gray-200 w-full p-2 text-center">Category</div>

        <div className="flex transition overflow-y-scroll overflow-x-hidden ease-in-out duration-300  items-center justify-center cursor-pointer ">
